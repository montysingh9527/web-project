  ...
  */
  ...
  function formatProps(attrs) {
    ...
    for (var i = 0; i < attrs.length; i++) {
      ...
      attrStr +=
        "".concat(attr.name) + ":" + "".concat(JSON.stringify(attr.value), ",");
  ...
  function generate(el) {
    ...
    var code = "_c('"
      .concat(el.tag, "', ")
      .concat(
        el.attrs.length > 0 ? "".concat(formatProps(el.attrs)) : "undefined"
      )
      .concat(children.length > 0 ? ",".concat(children) : "", ")"); // console.log(code);
