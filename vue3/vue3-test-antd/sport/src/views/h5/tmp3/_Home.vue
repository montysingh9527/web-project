<template>
  <div class="home re" @click="showUserInfo = false">
    ...
    <van-tabs class="f-tabs indexvantabs" v-model="active_tab" animated color="#7b5605" line-width="20vw">
      <van-tab key="tab1">
        <template #title>
          <div class="flex-middle" style="line-height: 1">
            <img class="m-r5" :src="active_tab === 0 ? tabs.sports.active_icon : tabs.sports.icon" style="height: .7rem;" alt=""> {{tabs.sports.text}}
          </div>
        </template>
      ...
      <van-tab key="tab1">
        <template #title>
          <div class="flex-middle" style="line-height: 1">
            <img class="m-r5" :src="active_tab === 1 ? tabs.real.active_icon : tabs.real.icon" style="height: .7rem;" alt=""> {{tabs.real.text}}
          </div>
        </template>
        <div class="index-continaer">
          <RealGame type="zr"></RealGame>
        </div>
      </van-tab>
      <van-tab key="tab1">
        <template #title>
          <div class="flex-middle" style="line-height: 1">
            <img class="m-r5" :src="active_tab === 2 ? tabs.dz.active_icon : tabs.dz.icon" style="height: .7rem;" alt=""> {{tabs.dz.text}}
          </div>
        </template>
        <div class="index-continaer">
          <RealGame type="dz" @click="handleClickSubGame"></RealGame>
        </div>
      </van-tab>
      <van-tab key="tab1">
        <template #title>
          <div class="flex-middle" style="line-height: 1">
            <img class="m-r5" :src="active_tab === 3 ? tabs.qp.active_icon : tabs.qp.icon" style="height: .7rem;" alt=""> {{tabs.qp.text}}
          </div>
        </template>
        <div class="index-continaer">
          <RealGame type="qp"></RealGame>
        </div>
      </van-tab>
      <van-tab key="tab1">
        <template #title>
          <div class="flex-middle" style="line-height: 1">
            <img class="m-r5" :src="active_tab === 4 ? tabs.buyu.active_icon : tabs.buyu.icon" style="height: .7rem;" alt=""> {{tabs.buyu.text}}
          </div>
        </template>
        <div class="index-continaer">
          <RealGame type="by"></RealGame>
        </div>
      </van-tab>
    </van-tabs>
