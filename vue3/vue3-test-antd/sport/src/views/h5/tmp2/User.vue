<template>
    <div class="user">
        <van-nav-bar
                style="background-color: #126E51!important;height:2.2rem"
        ...
        >
            ...
            <span slot="title" class="fs16 white">{{$t('m_c')}}</span>
        </van-nav-bar>
        <iframe :src="url"
                frameborder="0"
                scrolling="yes"
...
<script>
    export default {
        ...
        created() {
            ...
            this.url = `${host}/mobile/#/ucenter/index`
            // this.url = `http://localhost:18888/sporth5#/index/home`
