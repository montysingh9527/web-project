<template>
  <div class="page">
    <van-nav-bar title="演员" @click-left="$router.back()" style="height: 46px" :border="false" fixed placeholder>
      <template #left>
        <van-icon
          name="arrow-left"
          style="color: rgb(125, 125, 128); font-size: 16px"
        />
      </template>
    </van-nav-bar>
...
<script>
import { getCurrentInstance, onMounted, provide, ref, nextTick } from "vue";
